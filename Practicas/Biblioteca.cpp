...
{
	char opcion; //DECLARACIÓN DE VARIABLES
	...
	}while(opcion!=27);  // MIENTRAS NO SE PRESIONE LA OPCION DE SALIR SE SEGUIRA CICLANDO EL MENU
	return 0;
...
char Menu ()
{
	...
	gotoxy(35,7);  cout << "_______SISTENA BIBLIOTECARIO DE LA UTEG_______";
	gotoxy(42,10); cout << "[F1] Registrar titulos      		";
	gotoxy(42,11); cout << "[F2] Mostrar Titulos Almacenados    ";
	gotoxy(42,12); cout << "[F3] Ordenar Titulos Alfabeticamente";
	gotoxy(42,13); cout << "[F4] Buscar Titulo	    			";
	gotoxy(42,14); cout << "[Esc] SALIR                 		";
	gotoxy(42,16); cout << "INGRESE UNA OPCION: "; fflush(stdin);
	opcion1 = getch();	
}
